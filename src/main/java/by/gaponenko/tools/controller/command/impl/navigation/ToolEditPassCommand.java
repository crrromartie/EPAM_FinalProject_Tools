...
/**
 * The Tool edit pass command.
 * <p>
 * Forwarding admin to the tool edit page.
 *
 * @author Haponenka Ihar
 * @version 1.0
 */
public class ToolEditPassCommand implements Command {
    static Logger logger = LogManager.getLogger();

    @Override
    public Router execute(HttpServletRequest request) {
        Router router = new Router(PagePath.TOOL_EDIT_PAGE);
